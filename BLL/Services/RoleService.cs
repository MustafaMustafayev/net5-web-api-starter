...
namespace BLL.Services
{
    public class RoleService : IRoleService
    {
        ...
        {
            Role role = await _unitOfWork.RoleRepository.Get(m => m.RoleId == roleId);
            role.IsDeleted = true;
        ...
        {
            IQueryable<Role> roles =  await _unitOfWork.RoleRepository.GetList();
        ...
        {
            RoleToListDTO role = _mapper.Map<RoleToListDTO>(await _unitOfWork.RoleRepository.Get(m => m.RoleId == roleId));
        ...
        public async Task<IDataResult<RoleToListDTO>> Update(RoleToUpdateDTO roleToUpdateDTO)
        {
            ...
            Role updated = await _unitOfWork.RoleRepository.UpdateAsync(role);
            await _unitOfWork.Commit();
